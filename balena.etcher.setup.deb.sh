...
function die {
    ...
    echo -e "$prefix: "
    echo -e "$prefix: ${bold}You can contact Cloudsmith (support@cloudsmith.io) for further assistance.${reset}"
    echo -e "$prefix: "
...
EOF
 ...
 >>>>: doesn't work after an hour, please contact Cloudsmith (support@cloudsmith.io)
 >>>>: for assistance.
 >>>>:
EOF
        }
